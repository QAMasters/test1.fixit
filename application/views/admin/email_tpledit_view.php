                    ...
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
                            <form method="get" class="form-horizontal">
                                <div class="form-group"><label class="col-sm-3 control-label"><?php echo form_label('Template Name','tpl_name'); ?></label>
                                    <div class="col-sm-6">
                                    <?php echo form_input($tpl_name); ?>
                                    </div>
                                </div>
                                <div class="hr-line-dashed"></div>
                                <div class="form-group"><label class="col-sm-3 control-label"><?php echo form_label('Subject','tpl_subject'); ?></label>
                                    <div class="col-sm-6">
                                    <?php echo form_input($tpl_subject); ?>
                                    </div>
                                </div>                                
                                <div class="hr-line-dashed"></div>
								<div class="form-group"><label class="col-sm-3 control-label"><?php echo form_label('Message','tpl_message'); ?></label>
                                    <div class="col-sm-8">
										<textarea class="input-block-level" id="summernote" rows="10" name="tpl_message"><?php echo $email_tpl->message; ?></textarea>
									</div>
								</div>                                
                                <div class="hr-line-dashed"></div>
