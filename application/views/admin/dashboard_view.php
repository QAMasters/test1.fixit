...
<ul class="list-inline">
    ...
    <li><a href="#" class="unassigned btn btn-success btn-sm""><?php echo $this->lang->line('show_unassigned');?></a></li>   
                    ...
                    <table class="table table-striped table-bordered table-hover dataTables-example1" width="100%" border="0" cellspacing="0" cellpadding="0">
                    <thead>
                    <tr>
...
.dataTables_wrapper {
    padding-bottom: 10px;
                    ...
                    <div class="ibox-content">
                        <table class="table table-striped table-bordered table-hover invoice_table" width="100%" border="0" cellspacing="0" cellpadding="0">
                            <thead>
                                <tr>
                                    <th><?php echo $this->lang->line('name');?></th>
                                    <th><?php echo $this->lang->line('status');?></th>
