        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    <label for="p-in"
                           class="col-md-4 label-heading"><?php echo $this->lang->line('event_name'); ?></label>
                ...
                <div class="form-group">
                    <label for="p-in"
                           class="col-md-4 label-heading"><?php echo $this->lang->line('description'); ?></label>
                    <div class="col-md-8 ui-front">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    <label for="p-in"
                           class="col-md-4 label-heading"><?php echo $this->lang->line('delete_event'); ?></label>
                    <div class="col-md-8">
