...
<div class="wrapper wrapper-content animated fadeInRight">
                ...
                <div class="ibox float-e-margins">
                    <a class="collapse-link" style="color: inherit;">
                        <div class="ibox-title">
                            ...
                            <input type="checkbox" class="emergency" name="emergency"/> <font
                        ...
                        <div class="col-sm-3">
                            <div class="form-group"><label class="control-label">Start Time</label>
                                <input size="16" type="text" readonly class="start_datetime form-control"
                                       name="i_pref_s_time" value="">
                            </div>
                        </div>
                        <div class="col-sm-3">
                            <div class="form-group"><label class="control-label">End Time</label>
                                <input size="16" type="text" readonly class="end_datetime form_datetime form-control"
                                       name="i_pref_e_time" value="">
                            </div>
                        </div>
                    </div>
                    <div class="row">
    ...
    <div class="form-group text-center">
        <div>
            ...
            <button type="submit" class="btn btn-success" name="create_ticket"
                    class=""><?php echo $this->lang->line('create_ticket'); ?></button>
        </div>
    </div>
