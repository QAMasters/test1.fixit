                    ...
                    <div class="ibox-content">
                        ...
                        <div class="form-group"><label class="col-md-4 control-label"><?php echo $this->lang->line('phone');?> #</label>  
                            <div class="col-md-4 inputGroupContainer">
                                ...
                                <input name="phone" placeholder="<?php echo $this->lang->line('phold_phone');?>" class="form-control" type="number" oninput="this.value=this.value.slice(0,this.maxLength||1/1);this.value=(this.value   < 0) ? (1/1) : this.value;" maxlength="10" min="0" required data-minlength="10">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group"><label class="col-md-4 control-label" ><?php echo $this->lang->line('status');?></label> 
                            <div class="col-md-4 inputGroupContainer">
                                ...
                                <input type="checkbox" class="js-switch" name="status" checked="" />
                                    <span class="help-block"><?php echo $this->lang->line('enable');?>/<?php echo $this->lang->line('disable');?></span>
                                </div>
                            </div>
                        </div>
