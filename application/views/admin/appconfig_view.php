        ...
        <div class="col-lg-12">
            <div class="tabs-container">
                <ul class="nav nav-tabs">
                    ...
                    <li class=""><a data-toggle="tab" href="#tab-4"><h4><i class="fa fa-file"></i> Invoice</h4></a></li>
                ...
                <div class="tab-content">
                    ...
                    <div id="tab-2" class="tab-pane">
                        <div class="panel-body">
                            <?php echo form_open('settings/appconfig/update', 'class="form-horizontal"'); ?>
                            <!--<div class="form-group"><label class="col-sm-3 control-label"><?php echo $this->lang->line('app_url'); ?></label>
                                        <div class="col-sm-6"><input type="text" class="form-control" name="sysURL" value="<?php echo $appconfig->sysURL; ?>"></div>
                                    </div>-->
                            <div class="form-group"><label
                            ...
                            <!--<div class="hr-line-dashed"></div>
                                    <div class="form-group"><label class="col-sm-3 control-label"><?php echo $this->lang->line('default_lang'); ?></label>
                                        <div class="col-sm-6"><input type="text" class="form-control" name="defaultlang" value="<?php echo $appconfig->defaultlang; ?>"></div>
                                    </div>
                                    <div class="hr-line-dashed"></div>-->
                            <div class="form-group">
                                <div class="col-sm-4 col-sm-offset-3">
                    ...
                    <div id="tab-3" class="tab-pane">
                        <div class="panel-body">
                            ...
                            <div class="form-group"><label class="col-sm-3 control-label">Data1</label>
                                <div class="col-sm-6"><input type="text" placeholder="" class="form-control"
                                                             value="<?php echo $bank_details->d1; ?>" name="d1"></div>
                            </div>
                            <div class="form-group"><label class="col-sm-3 control-label">Data2</label>
                                <div class="col-sm-6"><input type="text" placeholder="" class="form-control"
                                                             value="<?php echo $bank_details->d2; ?>" name="d2"></div>
                            </div>
                            <div class="form-group"><label class="col-sm-3 control-label">Data3</label>
                                <div class="col-sm-6"><input type="text" placeholder="" class="form-control"
                                                             value="<?php echo $bank_details->d3; ?>" name="d3"></div>
                            </div>
                            <div class="form-group"><label class="col-sm-3 control-label">Data4</label>
                                <div class="col-sm-6"><input type="text" placeholder="" class="form-control"
                                                             value="<?php echo $bank_details->d4; ?>" name="d4"></div>
                            </div>
                            <div class="form-group"><label class="col-sm-3 control-label">Data5</label>
                                <div class="col-sm-6"><input type="text" placeholder="" class="form-control"
                    ...
                    <div id="tab-4" class="tab-pane">
                        <div class="panel-body">
                            <?php echo form_open('settings/appconfig/update', 'class="form-horizontal"'); ?>
                            <div class="form-group"><label class="col-sm-3 control-label">Rot Data</label>
