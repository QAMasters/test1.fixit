...
<script type="text/javascript" src="'.base_url().'inv/scripts.js"></script>
';
$xfooter='
                    ...
                    <div class="ibox-content p-xl">
                        <div class="row">
                            ...
                            <div class="col-sm-6 table-responsive m-t">
                                    ...
                                    <td align="center" width="25%"><b>Fakturadatum</b> <br><input type="text" name="invoice_date" value="<?php echo $inv->invoice_date; ?>">
                                        </td>
                            ...
                            <div class="table-responsive m-t">
                                <table class="table table-bordered" id="invoice_table">
                                    <thead>
                                    <tr>
                                        <th style="width: 10%"><a href="#" class="btn btn-success btn-xs add-row"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span></a>Nummer</th>
                                    ...
                                    <tbody>
                                    <tr><td><input type="text" class="form-control" name="rot_status" value=""></td>
                                    <td><input type="text" class="form-control" name="item_name[]" value=""></td>
                                    <td align="center"><input type="text" class="qty form-control" name="quantity[]" value="1"></td>
                                    <td width="10%"><select name="quantity_type[]" class="form-control" tabindex="-1"><option value=""></option>
                                    <td align="center"><input type="text" class="rate form-control" name="price[]" value=""></td>
                                    <td align="center"><input type="text" class="disc form-control" name="discount[]" value=""></td>
                                    <td align="center"><input type="text" class="cal form-control" name="total[]" value=""></td>
