            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                ...
                <div class="col-xs-5 col-sm-6 col-lg-4">
                    <div class="title-action">                        
                        ...
                        <a href="<?php echo base_url(); ?>tickets/publish?ticket_id=<?php echo $ticket->ticket_id?>&publish=true" class="btn btn-warning"><i class="fa fa-check-circle"></i> <?php echo $this->lang->line('publish');?></a>
                        <?php }else{ ?>
                        <a href="#Vendor" data-toggle="modal" data-hover="tooltip" title="Change Vendor" data-placement="top" data-whatever="<?php echo $ticket->ticket_id; ?>" class="btn btn-danger"><i class="fa fa-refresh fa-spin fa-fw"></i> <?php echo $this->lang->line('vendors');?> </a>
                        <?php } ?>
                        <!--<a href="<?php echo base_url(); ?>tickets/new" class="btn btn-success"><i class="fa fa-plus-circle"></i> New Ticket</a>-->
                        <a class="btn btn-primary" href="<?php echo base_url()?>tickets/pdf?ticket_id=<?php echo $ticket->ticket_id; ?>" target="_blank"><span class="glyphicon glyphicon-print" aria-hidden="true"></span> Print</a>
                    </div>                  
                </div>
            </div>
...
<div class="wrapper wrapper-content animated fadeInRight">
    ...
    ?>
        ...
        <a class="btn btn-danger btn-rounded btn-sm btn-outline" href="<?php echo $previous_value ; ?>"> << <?php echo $this->lang->line('previous_ticket');?></a></div>
    <?php
    }
    ...
    ?>
        ...
        <a class="btn btn-danger btn-rounded btn-sm btn-outline" href="<?php echo $next_value ; ?>"><?php echo $this->lang->line('next_ticket');?> >> </a></div>
    <?php
    }
    ?>
...
<div class="row">
    <div class="col-lg-12">
        <div class="ibox-title">
            <h5><?php echo '<font size="4"># '.$ticket->ticket_id.'</font>'?> </h5><span class="label label-"></span>
            <div class="ibox-tools" style="padding-right: 30px;">
                <label class="label label-<?php echo status_label($ticket->status); ?>" style="padding-top: 6px; padding-bottom: 6px;"><?php echo $ticket->status.$vendor ?></label>
                ...
                <div class="btn-group">
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="<?php echo base_url().'tickets/status/change?ticket_id='.$ticket->ticket_id.'&status=done' ?>">Work Completed</a></li>
                        <li><a href="<?php echo base_url().'tickets/status/change?ticket_id='.$ticket->ticket_id.'&status=raiseinvoice' ?>">Request Invoice</a></li>
                    </ul>
                </div>   
    
                <a href="event_download?ticket_id=<?php echo $ticket->ticket_id; ?>" class="btn btn-primary btn-sm" data-hover="tooltip" title="Download Calendar Event" data-placement="top"><i class="fa fa-download"></i> Event</a>                
                <a href="#Share" data-toggle="modal" data-whatever="<?php echo $ticket->ticket_id; ?>" class="btn btn-primary btn-sm" data-hover="tooltip" title="Share Ticket via Email" data-placement="top"><i class="fa fa-share-alt"></i> Share</a>
            </div>
        </div>
    </div>
</div>
        ...
        ?>
            <div class="ibox">
                ...
                <div class="ibox-title">
                    ...
                    <input type="checkbox" class="emergency" name="emergency" <?php if($ticket->emergency == '1'){echo 'checked';} ?> /> <font color="red"><?php echo $this->lang->line('emergency_high_priority');?> </font>
                ...
                <div class="ibox-content">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group"><label class=""><?php echo $this->lang->line('email');?></label>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-3">
                            <div class="form-group"><label class="control-label">Start Time</label>
                                    <input size="16" type="text" readonly class="start_datetime form-control" name="i_pref_s_time" value="<?php echo $ticket->pref_s_time; ?>" style="font-size:13px;">
                            </div>
                        </div>
                        <div class="col-sm-3">
                            <div class="form-group"><label class="control-label">End Time</label>
                                    <input size="16" type="text" readonly class="end_datetime form-control" name="i_pref_e_time" value="<?php echo $ticket->pref_e_time; ?>" style="font-size:13px;">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group"><label class="control-label"><?php echo $this->lang->line('location');?></label>
                                    ...
                                    <select name="service" class="form-control select2_demo_3" onchange="fetch_select(this.value);" required="required" data-error="Please Select a Serice" style="width: 100%">
                                        <option value=""><?php echo $this->lang->line('select')?></option>
                                        <?php foreach($services as $service){?>
                                            <option value="<?php echo $service?>" <?php if($service == $ticket->service){ echo "selected";} ?> ><?php echo $this->lang->line($service)?></option>
                                        <?php } ?>
                                    </select>
                            </div>
                        </div>
            ...
            <div class="ibox collapsed">
                ...
                <div class="ibox-content">
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group"><label class="control-label"><?php echo $this->lang->line('select_images'); ?></label>
            ...
            <div class="form-group text-center">
                ...
                <div> 
                <button type="submit" class="ticket_update btn btn-success"><?php echo $this->lang->line('update'); ?></button> 
                <button type="reset" onclick="window.history.go(-1);" class="btn btn-warning" ><?php echo $this->lang->line('close'); ?></button> 
...
<input type="hidden" name="ticket_id" value="<?php echo $ticket->ticket_id; ?>">
        <div class="table-responsive m-t">
            <table class="table table-bordered table-responsive" id="invoice_table">
                <thead>
                    <tr>
                        <th width="5%"><a href="#" class="btn btn-primary btn-xs add-row"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span></a></th>
                ...
                foreach ($inv_items as $inv_item) { ?>
                    <tr><td><div class="form-group form-group-sm  no-margin-bottom"><a href="#" class="btn btn-danger btn-xs delete-row"><span class="glyphicon glyphicon-remove" aria-hidden="true"></span></a></div></td>
                    <td><div class="form-group-sm  no-margin-bottom">
                    <?php echo form_input($invoice_product,$inv_item->item_name); ?>
                        </div></td>
                    <td class="text-right"><div class="form-group form-group-sm no-margin-bottom">
    ...
    <div class="">
    <button class="btn btn-success btn-sm" name="add_material"><i class="fa fa-plus-circle"></i> Add</button></div>
<?php echo form_close();?>        
                </div>
            </div>
        </div>
            ...
            <div class="ibox">
                ...
                <form method="POST" class="addcomment" action="addcomment">
                    ...
                    <div class="form-group">
                        <textarea class="form-control" placeholder="Your message" rows="3" name="comment" required></textarea>
                    </div>
                    <label> <input type="checkbox" class="private_comment" name="private" checked> <font color="#f8ac5a"> <?php echo $this->lang->line('make_private');?> </font></label>

                    <button type="submit" class="btn btn-success btn-block" name="addcomment" class="addcomment"><?php echo $this->lang->line('add_comment');?></button>
                </form>
                    <?php
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header modal-header-primary">
                    ...
                    <h2><i class="fa fa-refresh fa-spin fa-fw"></i> <?php echo $this->lang->line('change_vendor');?></h2>
                </div>
                ...
                <div class="modal-body">
                    ...
                    <h4>Current Vendor : <?php if($ticket->vendor != ''){echo get_user_name($ticket->vendor)->fname; }else{echo "Not Assigned"; }?></h4>
                    <div class="form-group">
                        <?php echo form_dropdown('vendor', $vendor_array, $ticket->vendor, $js); ?>
                    </div>
                </div>
                <div class="modal-footer">
                    <button class="btn btn-small btn-success" type="submit" name="avatar"><?php echo $this->lang->line('update');?></button>
...
<script type="text/javascript">
$("#Vendor").on("show.bs.modal",function(e){var a=$(e.relatedTarget),t=a.data("whatever"),o=$(this);o.find(".modal-body input").val(t)});
</script>
...
<script type="text/javascript">
$("#Material").on("show.bs.modal",function(e){var a=$(e.relatedTarget),t=a.data("whatever"),o=$(this);o.find(".ticket_id input").val(t)});
</script>
<!--share modal-->
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <input type="email" name="email" class="form-control" placeholder="<?php echo $this->lang->line('enter_email'); ?>">
                    </div>
                </div>
                <div class="modal-footer">
...
<script type="text/javascript">
$("#Share").on("show.bs.modal",function(e){var a=$(e.relatedTarget),t=a.data("whatever"),o=$(this);o.find(".ticket_id input").val(t)});
</script>
