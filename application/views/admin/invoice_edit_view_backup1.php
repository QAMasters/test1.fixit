...
<script src="'.base_url().'inv/simp/js/bootstrap.datetime.js"></script>
<script src="'.base_url().'inv/simp/js/scripts.js"></script>
';
include 'header.php';
?>
            ...
            <div class="col-lg-12">
                <div class="wrapper wrapper-content animated fadeInRight">
                    <div class="ibox-content p-xl">
                        <div class="row">
                            ...
                            <table class="table table-bordered">
                                <thead><tr><th colspan="4" width="800px"><h1 align="center"><b>Faktura</b></h1></th>
                                    </tr></thead>
                                ...
                                <td align="center" width="25%"><b>Fakturadatum</b> <br><input class="datepicker" data-date-format="yyyy-mm-dd" value="<?php echo $inv->invoice_date; ?>" name="invoice_date"></td>
                    ...
                    <table class="table table-borderless">
                        <tr><td width="50%" height="20px"><b>var referns</b> : <?php echo get_user_name($tic->vendor)->fname; ?></td>
                        ...
                        <tr><td width="50%" height="20px"><b>Er referens</b> : <?php echo $tic->ini_name; ?></td><td width="50%"><b>förfallodatum</b> : <?php echo date('Y-m-d', strtotime($inv->invoice_date. ' + '.$inv->bill_due.' days'));?></td></tr>
                    ...
                    <h4>ROT Status: <?php echo $inv->rot; ?> <font size="2px"><a href='#Rot' data-toggle='modal' data-hover='tooltip' title='ROT details' data-placement='top' data-whatever="<?php echo $tic->ticket_id;?>" class=''> View/Add ROT Details</a></font></h4><br>
...
$invoice_product_discount = array('type' => 'text', 'name' => 'invoice_product_discount[]', 'placeholder' => 'Enter % or value (ex: 10% or 10.50)', 'class' => 'form-control calculate');
$invoice_product_sub = array('type' => 'text', 'name' => 'invoice_product_sub[]', 'class' => 'form-control calculate-sub', 'id' => 'invoice_product_sub','readonly'=>'');
...
?>  
            <table class="table table-bordered" id="invoice_table">
                ...
                <tbody>
                    ...
                    <td class="text-right" width="10%"><div class="input-group input-group-sm  no-margin-bottom"><span class="input-group-addon"><small>SEK</small></span>
                    ...
                    <td class="text-right" width="10%"><div class="input-group input-group-sm"><span class="input-group-addon"><small>SEK</small></span>
                    ...
                    <td class="text-right" width="10%"><div class="input-group input-group-sm"><span class="input-group-addon"><small>SEK</small></span><?php echo form_input($invoice_product_sub,'0.00'); ?></div></td>
                    </tr>
                </tbody>
            </table>
            <!--items end here-->
            <div id="invoice_totals" class="padding-right row text-right">
                <div class="col-xs-6 pull-right">
                    <div class="row">
                        ...
                        <div class="col-xs-3">
                            SEK <span class="invoice-shipping">0.00</span>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-3">
                            SEK <span class="invoice-sub-total">0.00</span>
                   ...
                   <?php if (ENABLE_VAT == true) { ?>
                    <div class="row">
                        <div class="col-xs-4 col-xs-offset-5">
                            <strong>TAX/VAT (Moms):</strong><br>Remove TAX/VAT <input type="checkbox" class="remove_vat">
                        </div>
                        <div class="col-xs-3">
                            SEK <span class="invoice-vat" data-enable-vat="<?php echo ENABLE_VAT ?>" data-vat-rate="<?php echo VAT_RATE ?>" data-vat-method="<?php echo VAT_INCLUDED ?>">0.00</span>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-3">
                            SEK <span class="invoice-roundoff">0.00</span>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-3">
                            SEK <span class="invoice-tax_credit">0.00</span>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-3">
                            SEK <span class="invoice-total">0.00</span>
            ...
            <div class="row">
                <div class="col-xs-12 margin-top btn-group">
                    <input type="submit" class="btn btn-success float-right" value="Save Invoice" data-loading-text="Saving...">
                </div>
            </div>        
    </div>
    </div>
