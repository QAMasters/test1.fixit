                    ...
                    <div class="ibox-content p-xl">
                        ...
                        <table class="table table-bordered" id="invoice_table">
                            ...
                            foreach ($inv_items as $inv_item) { ?>
                                <tr>
                                    ...
                                    <td class="text-right" width="10%">
                                        <div class="input-group input-group-sm  no-margin-bottom"><span
                                                    class="input-group-addon"><small>SEK</small></span>
                                    ...
                                    <td class="text-right" width="10%">
                                        <div class="input-group input-group-sm"><span class="input-group-addon"><small>SEK</small></span>
                            ...
                            <tr>
                                ...
                                <td class="text-right" width="10%">
                                    <div class="input-group input-group-sm"><span class="input-group-addon"><small>SEK</small></span><?php echo form_input($invoice_product_sub, '0.00'); ?>
                                    </div>
                                </td>
                            </tr>
                            </tbody>
                            ...
                            <div class="col-xs-6 pull-right">
                                ...
                                <?php if (ENABLE_VAT == true) { ?>
                                    <div class="row">
                                        ...
                                        <div class="col-xs-3">
                                            SEK <span class="invoice-vat" data-enable-vat="<?php echo ENABLE_VAT ?>"
