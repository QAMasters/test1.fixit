            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>Ärende historik</h5>
                    </div>
                    <div class="ibox-content">
                        <form role="form" class="form-inline" method="POST" action="">
                            <div class="form-group">
                                <label><?php echo $this->lang->line('ticket_id');?></label> <input type="text" placeholder="<?php echo $this->lang->line('placeholder_ticket_history_enter_ticket_id'); ?>" class="form-control" name="ticket_id" required="">
                                <button class="btn btn-sm btn-success" type="submit" name="get_history"><strong><?php echo $this->lang->line('submit');?></strong></button>
                            </div>
                        </form>
                    </div>
                <?php
