    ...
    <div class="row wrapper border-bottom white-bg page-heading">
                ...
                <div class="col-xs-5 col-sm-6 col-lg-4">
                    <div class="title-action">
                        ...
                        <a class="btn btn-primary" href="<?php echo base_url()?>invoice/pdf?ticket_id=<?php echo $tic->ticket_id; ?>" target="_blank"><span class="glyphicon glyphicon-print" aria-hidden="true"></span> Print</a>
                    </div>                  
                </div>
            ...
            <div class="col-lg-12">
                <div class="wrapper wrapper-content animated fadeInRight">
                    <div class="ibox-content p-xl">
                        <div class="row">
                            <div class="col-sm-6">
                                <img src="<?php echo base_url('uploads/logo/').$appconfig->logo;?>">
                            </div>
                            <div class="col-sm-6 table-responsive m-t">
                            <table class="table table-bordered">
                                <thead><tr><th colspan="4" width="800px"><h1 align="center"><b><?php echo $this->lang->line('invoice');?></b></h1></th>
                                    </tr></thead>
                                <tr><td align="center" width="25%" height="50px"><b><?php echo $this->lang->line('invoice_number');?></b> <br><?php echo $inv->invoice_id; ?></td>
                                <td align="center" width="25%"><b><?php echo $this->lang->line('customer_number');?></b> <br></td>
                                <td align="center" width="25%"><b><?php echo $this->lang->line('invoice_date');?></b> <br><input class="datepicker" data-date-format="yyyy-mm-dd" value="<?php echo $inv->invoice_date; ?>" name="invoice_date"></td>
                                <td align="center" width="25%"><b><?php echo $this->lang->line('page');?></b> <br>1</td></tr>
                                <tr style="vertical-align: top; text-align: left;">
                                    <td colspan="4" width="25%" height="100px"><b><?php echo $this->lang->line('billing_address');?></b><br><?php echo $tic->ini_name."<br>".$tic->ini_address;?></td></tr>
                            </table>
                            </div>
                        </div><br>
                    <table class="table table-borderless">
                        <tr><td width="50%" height="20px"><b><?php echo $this->lang->line('var_reference');?></b> : <?php if($tic->vendor != ''){ echo get_user_name($tic->vendor)->fname; }?></td>
                        <td width="50%"><b><?php echo $this->lang->line('terms_of_payment');?></b>  : 
                            <select name="bill_due" class="" style="" onchange="change_bill_due(this.value);">
                             <?php
                             if($inv->bill_due == '10'){
                        ...
                        <tr><td width="50%" height="20px"><b><?php echo $this->lang->line('your_reference');?></b> : <?php echo $tic->ini_name; ?></td><td width="50%"><b><?php echo $this->lang->line('expiration_date');?></b> : <?php echo date('Y-m-d', strtotime($inv->invoice_date. ' + '.$inv->bill_due.' days'));?></td></tr>
                        <tr><td width="50%" height="20px"><b><?php echo $this->lang->line('your_order_number');?></b> : <?php echo $tic->ticket_id; ?></td><td width="50%"></td></tr>
                    </table>
                    <table class="table table-bordered">
                        <tr><td><?php echo $this->lang->line('description');?></td></tr>
                        <tr><td><textarea class="form-control" name="description"><?php echo $inv->description?></textarea>
                            </td></tr>
                    </table>
                    <h4><?php echo $this->lang->line('rot_status');?>: <?php echo $inv->rot; ?> <font size="2px"><a href='#Rot' data-toggle='modal' data-hover='tooltip' title='ROT details' data-placement='top' data-whatever="<?php echo $tic->ticket_id;?>" class=''> <?php echo $this->lang->line('view_add_rot');?></a></font></h4><br>
...
?>          <div class="table-responsive m-t">
            <table class="table table-bordered table-responsive" id="invoice_table">
                <thead>
                    <tr>
                        <th><h4><a href="#" class="btn btn-primary btn-xs add-row"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span></a></h4></th>
                ...
                foreach ($inv_items as $inv_item) { ?>
                    ...
                    <td class="text-right" width="10%"><div class="input-group input-group-sm  no-margin-bottom">
                    <?php echo form_input($invoice_product_price,$inv_item->price); ?>
                    </div></td>
                    <td class=""><div class="form-group form-group-sm  no-margin-bottom">
                    ...
                    <td class="text-right" width="10%"><div class="input-group input-group-sm">
                ...
                <?php } ?>
                    ...
                    <td class="text-right" width="10%"><div class="input-group input-group-sm">
                        <?php echo form_input($invoice_product_sub,'0.00'); ?></div></td>
                    </tr>
                </tbody>
            </table>
        </div>
            ...
            <div id="invoice_totals" class="padding-right row text-right">
                ...
                <table class="table-responsive"><tr><td width="50%">
                    <div class="row">
                   ...
                   <?php if (ENABLE_VAT == true) { ?>
                    <div class="row">
                        <div class="col-xs-4 col-xs-offset-5">
                            <strong><?php echo $this->lang->line('tax_vat');?>:</strong>
            ...
            <div class="row">
                <div class="col-xs-12 margin-top btn-group">
                    <input type="submit" class="btn btn-success float-right" value="<?php echo $this->lang->line('save_invoice');?>" data-loading-text="Saving...">
                </div>
            </div>        
    </div>
    </div>
...
<div class="modal fade" id="Rot" tabindex="-1" role="dialog" aria-labelledby="CloseLabel">
    <div class="modal-dialog vertical-align-center" role="document">
        <div class="modal-content animated fadeIn">
            ...
            <form class="form-horizontal" method="POST" action="<?php echo base_url();?>invoices/update_rot" data-toggle="validator">
            <input type="hidden" name="ticket_id" class="form-control ticket_id" value="<?php echo $tic->ticket_id; ?>">
                <div class="modal-body">
                    <div class="form-group"><label class="col-lg-5 control-label"><?php echo $this->lang->line('rot_label1');?></label>
                        <div class="col-lg-7"><input type="text" name="label1" value="<?php if(isset($rot->label1)){echo $rot->label1;} ?>" class="form-control">
                        </div>
                    </div>
                    <div class="form-group"><label class="col-lg-5 control-label"><?php echo $this->lang->line('rot_label2');?></label>
                        <div class="col-lg-7"><input type="text" name="label2" value="<?php if(isset($rot->label2)){echo $rot->label2;} ?>" class="form-control"> 
                        </div>
                    </div>
                    <div class="form-group"><label class="col-lg-5 control-label"><?php echo $this->lang->line('rot_label3');?></label>
                        <div class="col-lg-7"><input type="text" name="label3" value="<?php if(isset($rot->label3)){echo $rot->label3;} ?>" class="form-control"> 
                        </div>
                    </div>
                    
                    <div class="form-group"><label class="col-lg-5 control-label"><?php echo $this->lang->line('rot_label4');?></label>
                        <div class="col-lg-7"><input type="number" name="personal_number" value="<?php if(isset($rot->personal_number)){echo $rot->personal_number;} ?>" class="form-control" placeholder="yyyymmddaaaa" min="0"  maxlength="12" oninput="this.value=this.value.slice(0,this.maxLength||1/1);this.value=(this.value   < 0) ? (1/1) : this.value;" required="" data-minlength="12"> 
                        </div>
                    </div>
                </div>
                <div class="modal-footer">
                    <input type="submit" value="<?php echo $this->lang->line('add_rot_data');?>" name="rot" class="btn btn-success" />
                </div>
            </form>
        </div>
    </div>
