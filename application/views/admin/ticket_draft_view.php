...
$("#Close").on("show.bs.modal",function(e){var a=$(e.relatedTarget),t=a.data("whatever"),o=$(this);o.find(".modal-body input").val(t)});
</script>
<!--=============================Ticket Delete Modal====================-->
...
<script type="text/javascript">
$("#Reminder").on("show.bs.modal",function(e){var a=$(e.relatedTarget),t=a.data("whatever"),o=$(this);o.find(".modal-body input").val(t)});
</script>
