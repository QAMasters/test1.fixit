            ...
            <div class="col-sm-10 col-sm-offset-1 rotateInUpLeft">
                ...
                <div class="portlet portlet-bordered">
                    <div class="portlet-title">
                        <p class="pull-left" style="font-size: 18px;"><?php echo $this->lang->line('lbl_pers_info');?> <input type="checkbox" class="emergency" name="emergency" <?php if($ticket->emergency == '1'){echo 'checked';} ?> /> <span style="font-size: 15px; color: red; "><?php echo $this->lang->line('emergency_high_priority');?> </span></p> 
                    </div>
                        ...
                        <div class="row">
                            <div class="col-sm-6 form-group">
                                ...
                                <div class="input-group col-md-12 col-xs-12">
                                    ...
                                    <select name="service" class="select2_demo_3" onchange="fetch_select(this.value);" required="required" data-error="Please Select a Serice" style="width: 100%">
