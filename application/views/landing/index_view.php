...
<html>
    <head>
        ...
        <link href="./assets1/plugins/pricing-tables/css/style.css" rel="stylesheet" type="text/css">
        ...
        <script src="./assets1/plugins/pricing-tables/js/modernizr.js"></script>
...
window.cookieconsent.initialise({
  ...
  "position": "bottom-right"
    ...
    <body data-spy="scroll" data-target="#header">
            ...
            <div class="container">
                ...
                <div id="navbar" class="navbar-collapse collapse navbar-right">
                    <ul class="nav navbar-nav">
                        ...
                        <li><a href="#" data-toggle="modal" data-target="#Login"><?php echo $this->lang->line('login');?></a></li>
                        <li class="dropdown">
                            <?php
                            if($pref_lang == 'en'){
            ...
            <div class="container">
                <div class="row">
                    <div class="home-text col-md-8">
                        <h1 class="wow fadeInDown" data-wow-delay="1.5s" data-wow-duration="1.5s" data-wow-offset="10"><?php echo $this->lang->line('main_lbl');?></h1>

                        <p class="lead wow fadeInDown" data-wow-delay="2s" data-wow-duration="1.5s" data-wow-offset="10"></p>
                        
                        <a href="create-ticket" class="btn btn-success btn-rounded btn-lg wow fadeInUp" data-wow-delay="2.5s" data-wow-duration="1.5s" data-wow-offset="10"> <i class="fa fa-share faa-flash animated"></i> <?php echo $this->lang->line('raise_ticket');?></a>
                    </div>
                    ...
                    <div class="col-md-12 col-md-offset-0 col-sm-11 col-sm-offset-1 col-lg-offset-1 text-center">
                            <div class="col-md-3">
                                <div class="thumbnail wow rotateInUpLeft" data-wow-duration="1.5s" data-wow-offset="10" data-wow-delay="0.5s">
                                    ...
                                    <img src="<?php base_url()?>assets/img/services/apartment.jpg" style="width: 100%" alt="Gallery Image">
                                    <div class="caption"><h3><?php echo $this->lang->line('apartment');?></h3></div></a>
                                </div>
                            </div> <!-- /.col -->
                            <div class="col-md-3">
                                <div class="thumbnail wow rotateInUpLeft" data-wow-duration="1.5s" data-wow-offset="10" data-wow-delay="0.5s">
                                    <a href="create-ticket?service=Bathroom">
                                    <img src="<?php base_url()?>assets/img/services/bedroom.jpg" style="width: 100%" alt="Gallery Image">
                                    <div class="caption"><h3><?php echo $this->lang->line('bathroom');?></h3></div></a>
                                </div>
                            </div> <!-- /.col -->
                            <div class="col-md-3">
                                <div class="thumbnail wow rotateInUpLeft" data-wow-duration="1.5s" data-wow-offset="10" data-wow-delay="0.5s">
                                    <a href="create-ticket?service=Hall">
                                    <img src="<?php base_url()?>assets/img/services/hall.jpg" style="width: 100%" alt="Gallery Image">
                                    <div class="caption"><h3><?php echo $this->lang->line('hall');?></h3></div></a>
                                </div>
                            </div> <!-- /.col -->
                        </div> <!-- /.col big-->
                </div>
                    ...
                    <div class="col-md-12 col-md-offset-0 col-sm-11 col-sm-offset-1 col-lg-offset-1 text-center">
                            <div class="col-md-3">
                                <div class="thumbnail wow rotateInUpRight" data-wow-duration="1.5s" data-wow-offset="10" data-wow-delay="0.5s">
                                    ...
                                    <img src="<?php base_url()?>assets/img/services/kitchen.jpg" style="width: 100%" alt="Gallery Image">
                                    <div class="caption"><h3><?php echo $this->lang->line('kitchen');?></h3></div></a>
                                </div>
                            </div> <!-- /.col -->
                            <div class="col-md-3">
                                <div class="thumbnail wow rotateInUpRight" data-wow-duration="1.5s" data-wow-offset="10" data-wow-delay="0.5s">
                                    ...
                                    <img src="<?php base_url()?>assets/img/services/bedroom.jpg" style="width: 100%" alt="Gallery Image">
                                    <div class="caption"><h3><?php echo $this->lang->line('bedroom');?></h3></div></a>
                                </div>
                            </div> <!-- /.col -->
                            <div class="col-md-3">
                                <div class="thumbnail wow rotateInUpRight" data-wow-duration="1.5s" data-wow-offset="10" data-wow-delay="0.5s">
                                    <a href="create-ticket?service=Living room">
                                    <img src="<?php base_url()?>assets/img/services/livingroom.jpg" style="width: 100%" alt="Gallery Image">
                                    <div class="caption"><h3><?php echo $this->lang->line('living_room');?></h3></div></a>
                                </div>
                            </div> <!-- /.col -->
                    </div> <!-- /.col big -->
                </div>    
                    ...
                    <div class="col-sm-8 col-sm-offset-3 wow rotateInUpLeft" data-wow-duration="1.5s" data-wow-offset="10" data-wow-delay="0.5s">                       
                        ...
                        <form class="form-inline" method="GET" action="track-ticket" data-toggle="validator">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control input-lg" placeholder="<?php echo $this->lang->line('ticket_id');?>" name="ticket_id" required="">
                            </div>
                            <div class="form-group">
                                <label class="sr-only" for="exampleInputPassword2">Phone</label>
                                <div class="input-group m-d"><span class="input-group-addon">+46</span>
                                    <input type="number" class="form-control input-lg" placeholder="<?php echo $this->lang->line('phold_phone');?>" name="phone" oninput="this.value=this.value.slice(0,this.maxLength||1/1);this.value=(this.value   < 0) ? (1/1) : this.value;" maxlength="10" min="0" required data-minlength="10">
                                </div>
                                
                            </div>
                            <button type="submit" class="btn btn-success btn-lg"><?php echo $this->lang->line('track');?></button>
                        </form>
                    </div>
                </div>
            </div>
                     ...
                     <div class="row text-left">
                        ...
                        <div class="col-sm-4">
                           ...
                           <ul class="list-unstyled">
                                ...
                                <li><p><i class="fa fa-envelope m-r-xs"></i><a href="mailto:info@reitsolution.se">info@reitsolution.se</a></p></li>
        ...
        <!-- Javascripts -->
        <script src="./assets1/plugins/jquery/jquery-2.1.4.min.js"></script>
        <script src="./assets1/plugins/jquery-ui/jquery-ui.min.js"></script>
        <script src="./assets1/plugins/pace-master/pace.min.js"></script>
        ...
        <script src="./assets1/plugins/uniform/jquery.uniform.min.js"></script>
        <script src="./assets1/plugins/wow/wow.min.js"></script>
        <script src="./assets1/plugins/tabstylesinspiration/js/cbpfwtabs.js"></script>
        <script src="./assets1/plugins/pricing-tables/js/main.js"></script>
        <script src="./assets1/js/landing.js"></script>
            ...
            <div class="modal-body">
                ...
                <form method="POST" action="login">
                    <div class="form-group">
                        ...
                        <input type="email" class="form-control" id="exampleInputEmail1" name="email" placeholder="<?php echo $this->lang->line('enter_email'); ?>">
                    </div>
                    <div class="form-group">
