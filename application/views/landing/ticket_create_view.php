            ...
            <div class="container">
                ...
                <div id="navbar" class="navbar-collapse collapse navbar-right">
                    <ul class="nav navbar-nav">
                        ...
                        <li><a href="" data-toggle="modal" data-target="#myModal"><?php echo $this->lang->line('login');?></a></li>
                        <li class="dropdown">
                            <?php
                            if($pref_lang == 'en'){
...
if(isset($n_ticket)){
    ...
    $i_email = array('type' => 'email', 'name' => 'i_email', 'value' => $n_email, 'placeholder' => $this->lang->line('phold_email'), 'class' => 'form-control', 'required' => 'required', 'data-error'=>'Please Enter Email');
...
<div id="contact">
    <div class="container">
            ...
            <div class="col-sm-10 col-sm-offset-1 rotateInUpLeft">
                ...
                <div class="portlet portlet-bordered">
                    <div class="portlet-title">
                        <p class="pull-left" style="font-size: 18px;"><?php echo $this->lang->line('lbl_pers_info');?> <input type="checkbox" class="emergency" name="emergency"/> <span style="font-size: 15px; color: red; "><?php echo $this->lang->line('emergency_high_priority');?> </span></p> 
                    </div>
                ...
                <div class="portlet portlet-bordered">
                    <div class="portlet-title">
                        <p class="pull-left" style="font-size: 18px;"><?php echo $this->lang->line('lbl_addr_info');?></p> 
                    </div>
                    <div class="portlet-body">
                        <div class="row">
                            <div class="col-sm-6 form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-3 form-group">
                                ...
                                <div class="input-group col-md-12 col-xs-12">
                                    <input size="16" type="text" readonly class="start_datetime form-control" name="i_pref_s_time" value="<?php echo $n_pref_s_time; ?>">
                                </div>
                            </div>
                            <div class="col-sm-3 form-group">
                                <label class="control-label">End Time</label>
                                <div class="input-group col-md-12 col-xs-12">
                                    <input size="16" type="text" readonly class="end_datetime form-control" name="i_pref_e_time" value="<?php echo $n_pref_e_time; ?>">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                ...
                <div class="portlet portlet-bordered">
                    <div class="portlet-title">
                        <p class="pull-left" style="font-size: 18px;"><?php echo $this->lang->line('lbl_service_info');?></p> 
                    </div>
                    <div class="portlet-body">
                        <div class="row">
                            <div class="col-sm-6 form-group">
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="input-group col-md-12 col-xs-12">
                                    <?php echo form_dropdown('sub_service', $selected_sub_service, $selected_sub_service1, $sub_serv_opt); ?>
                                </div>
                            </div>
                        </div>
                        <div class="row">
        ...
        </div><br><button type="submit" class="btn btn-success btn-lg" name="create"><?php echo $this->lang->line('create_ticket');?></button>
    </form>
	</div>
</div>

<form method="POST" action="" class="m_ticket" id="m_ticket">
    <input type="hidden" name="new_ticket_id" value="<?php if(isset($new_ticket_id)){ echo $new_ticket_id; }?>">
</form>
...
$(document).ready(function(){
    ...
    swal({
        ...
        cancelButtonText: 'OK',
        confirmButtonText: 'Want Create Another Ticket?'
    }).then(function () {
